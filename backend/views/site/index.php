...
<div class="site-index d-flex">
    <div class="card m-2" style="width: 14rem;">
        <?php if ($latestVideo): ?>
            <div class="embed-responsive embed-responsive-16by9 mb-2" style="max-width: 200px">
                <video class="embed-responsive-item"
                       poster="<?php echo $latestVideo->getThumbnailLink() ?>"
                       src="<?php echo $latestVideo->getVideoLink() ?>"
                       style="max-width: 222px; border-top-left-radius: 3px; border-top-right-radius: 3px;"></video>
            </div>
            <div class="card-body">
